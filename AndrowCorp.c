...
evalCoup* jouer(dalle g[10][10], int color, int pro);
			...
			for (j=1; j<9; j++) {
                ...
                for (i = 0; i<10; i++) {
                        for (j=1; j<9; j++) {
                                if (grid[i][j].joueur == 2) {
                                     	acc = acc - (distance(grid, i, j));
					acc = acc - (nbrcasevidearriver(grid,1));
					if ((i == 0) && (j > 5)) {
						acc = acc + 10;
					} 
					if(defaite(grid)) {
				...
				if ((grid[i][j].pion->type == CERCLE) && (i == 0 && (j == 1 || j == 8))) {
						acc = acc + 15;
					}

				if ((grid[i][j].pion->type == LOSANGE) && (i == 0)) {
						acc = acc + 35;
					}
				if ((grid[i][j].pion->type == LOSANGE) && (i == 1) && (grid[0][j-1].joueur == 1 || grid[0][j+1].joueur == 1)) {
						acc = acc - 1000;
					}
				if ((grid[i][j].pion->type == TRIANGLE) && (i == 1) && (grid[0][j-1].joueur == 1 || grid[0][j+1].joueur == 1)) {
						acc = acc - 1000;
					}
				if ((grid[i][j].pion->type == TRIANGLE) && (i == 0) && (j != 1) && (j != 9) && (((grid[1][j-1].joueur == 1) || (grid[1][j+1].joueur == 1)) || ((grid[1][j-1].joueur == 1) || (grid[1][j+1].joueur == 1)))) {
						acc = acc - 30;
					}
				if ((grid[i][j].pion->type == LOSANGE) && (i == 0) && (j != 1) && (j != 9) && (((grid[1][j-1].joueur == 1) || (grid[1][j+1].joueur == 1)) || ((grid[1][j-1].joueur == 1) || (grid[1][j+1].joueur == 1)))) {
						acc = acc - 30;
					}
				if ((grid[i][j].pion->type == TRIANGLE) && (i == 0)) {
						acc = acc + 30;
					}
					...
					if((j < 2 || j > 7) && (grid[i][j].pion->type == TRIANGLE || grid[i][j].pion->type == LOSANGE) && (i == 1)) {
...
int victoire(dalle g[10][10]) {
	if ((g[9][1].joueur == g[9][1].ajoueur) &&(g[9][2].joueur == g[9][1].ajoueur) && (g[9][3].joueur == g[9][1].ajoueur) && (g[9][4].joueur == g[9][1].ajoueur) && (g[9][5].joueur == g[9][1].ajoueur) &&(g[9][6].joueur == g[9][1].ajoueur) &&(g[9][7].joueur == g[9][1].ajoueur) &&(g[9][8].joueur == g[9][1].ajoueur)) {
		printf("victoire");
		return 1;
	} else {
...
int defaite(dalle g[10][10]) {
        if ((g[0][1].joueur == g[0][1].ajoueur) &&(g[0][2].joueur == g[0][1].ajoueur) && (g[0][3].joueur == g[0][1].ajoueur) && (g[0][4].joueur == g[0][1].ajoueur) && (g[0][5].joueur == g[0][1].ajoueur) &&(g[0][6].joueur == g[0][1].ajoueur) &&(g[0][7].joueur == g[0][1].ajoueur) &&(g[0][8].joueur == g[0][1].ajoueur)){
                return 1;
        } else {
...
evalCoup* jouer(dalle g[10][10], int color, int pro) {
		...
		while (moves != NULL) {
			dalle ngrid[10][10];
            		copy(g, ngrid);
            		deplacement(ngrid, moves->move[0], moves->move[1], moves->move[2], moves->move[3]);
			coups = addC(coups, moves->move, minmax (ngrid, pro, -99999, 99999, 0, color));
			moves = moves->next;
...
evalCoup* jouerx(dalle g[10][10], int color) {
                ...
                while (moves != NULL) {
                        ...
                        copy(g, ngrid);
                        deplacement(ngrid, moves->move[0], moves->move[1], moves->move[2], moves->move[3]);
                        coups = addC(coups, moves->move, maxx(ngrid, 30, -99999,color));
                        moves = moves->next;
